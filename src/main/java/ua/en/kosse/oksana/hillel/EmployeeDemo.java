...
import ua.en.kosse.oksana.hillel.Avto.Car;
import ua.en.kosse.oksana.hillel.Direction.Address;
...
public class EmployeeDemo {
    public static void main(String[] args) {
        ...
        ua.en.kosse.oksana.hillel.Adds.Address addressPerson = new ua.en.kosse.oksana.hillel.Adds.Address();
